...
TEXT = {
    ...
    "मराठी": {
        "tagline": "अन्नदाते, स्वयंसेवी संस्था आणि स्वयंसेवकांना स्मार्ट जुळणी प्रणालीद्वारे जोडणे",
        ...
        "invalid_creds": "वापरकर्तानाव, पासवर्ड किंवा भूमिका चुकीची आहे.",
        "pwd_mismatch": "दोन्ही पासवर्ड जुळत नाहीत.",
        "reg_success": "नोंदणी यशस्वी झाली. कृपया लॉगिन करा.",
        "username_exists": "हे वापरकर्तानाव आधीपासून वापरात आहे.",
    },
    "हिंदी": {
        "tagline": "खाद्य दाताओं, स्वयंसेवी संस्थाओं और स्वयंसेवकों को स्मार्ट मिलान प्रणाली के माध्यम से जोड़ना",
        ...
        "invalid_creds": "उपयोगकर्ता नाम, पासवर्ड या भूमिका गलत है।",
        "pwd_mismatch": "दोनों पासवर्ड मेल नहीं खाते।",
        "reg_success": "पंजीकरण सफल रहा। कृपया लॉगिन करें।",
        "username_exists": "यह उपयोगकर्ता नाम पहले से उपयोग में है।",
    }
}
...
def page_auth():
    ...
    with tab2:
        with st.form("register_form", clear_on_submit=False):
            ...
            email = st.text_input(T("email"),value=st.session_state.registration_email)
            ...
            create_account = st.form_submit_button(T("create_account"),use_container_width=True)
        ...
        if create_account:
            ...
            elif email != st.session_state.verified_email:
